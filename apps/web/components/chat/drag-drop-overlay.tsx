...
export const DragDropOverlay = ({ isVisible, isDragOver }: DragDropOverlayProps) => {
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
        ...
        >
          <div
            className={`
              ...
              border-4 border-dashed transition-colors duration-200
              ${
                isDragOver
          ...
          >
            <div className="flex flex-col items-center gap-4 rounded-lg bg-background/95 p-8 shadow-lg backdrop-blur-sm dark:bg-background/95">
              ...
              <div className="text-center">
                ...
                `}>
                  {isDragOver ? "Drop files here" : "Drag files anywhere to upload"}
                </p>
